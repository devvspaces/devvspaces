...
I love building open source projects, learning, and teaching in public through the 34893 words I’ve written on [thecodeway.hashnode.dev](https://thecodeway.hashnode.dev/).<br>You might like my latest blog post: **[Streamlining Big Number Calculations in C using GMP](https://thecodeway.hashnode.dev/streamlining-big-number-calculations-in-c-using-gmp)**. You can subscribe to my [**blog RSS**](https://thecodeway.hashnode.dev/rss.xml) or follow me at [**thecodeway.hashnode.dev**](https://thecodeway.hashnode.dev).<br><br>
...
<br>
	<br><sub>Last updated by Luffy Senpai on 30 Jul 2023.</sub><br>