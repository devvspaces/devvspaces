...
I love building open source projects, learning, and teaching in public through the 36655 words I’ve written on [thecodeway.hashnode.dev](https://thecodeway.hashnode.dev/).<br>You might like my latest blog post: **[Building and Testing C Projects with GitHub Actions](https://thecodeway.hashnode.dev/building-and-testing-c-projects-with-github-actions)**. You can subscribe to my [**blog RSS**](https://thecodeway.hashnode.dev/rss.xml) or follow me at [**thecodeway.hashnode.dev**](https://thecodeway.hashnode.dev).<br><br>
...
<br>
	<br><sub>Last updated by Luffy Senpai on 14 Aug 2023.</sub><br>